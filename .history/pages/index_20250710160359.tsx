    ...
    <div style={{
          ...
          {!user ? (
            <div style={{
              ...
              <form
                onSubmit={async (e) => {
                  ...
                  if (signUpError) {
                    ...
                    if (userId) {
                      // Call API to create Stripe customer and update user metadata
                      ...
                      if (res.ok) {
                        ...
                        setSignupError("Failed to create Stripe customer");
                      }
                    }
                  }
                }}
              >
                ...
                <button type="submit" style={{ background: "#0af", color: "#000", padding: "10px 16px", borderRadius: 6, fontWeight: "bold", cursor: "pointer" }}>
              ...
              <button
                ...
                style={{ marginTop: 12, textDecoration: "underline", background: "none", border: "none", color: "#0af", cursor: "pointer" }}
              >
                {signupMode ? "Already have an account? Log In" : "Need to create an account? Sign Up"}
              </button>
            </div>
          ) : (
            <div style={{ color: "#fff" }}>
              ...
              <button
                ...
                style={{ background: "#f33", color: "#fff", border: "none", padding: 10, borderRadius: 6, cursor: "pointer" }}
              >
                Log Out
              </button>
            </div>
      ...
      {(windowWidth >= 800 || activePanel === "right") && (
        <div style={{
          ...
          <p>{message}</p>
          {/* Add more business controls here */}
          <BusinessCarousel />
        </div>
      )}
    </div>

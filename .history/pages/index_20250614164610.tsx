...
export default function Home() {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', backgroundColor: '#f9fafb' }}>
      ...
      <div style={{ flex: 1, padding: 20, borderLeft: '1px solid #e5e7eb', overflowY: 'auto', height: '100vh', backgroundColor: '#f3f4f6' }}>
        <h2 style={{ textAlign: 'center', color: '#111827' }}>Company Suite</h2>
        {['Art', 'Entertainment', 'Cuisine', 'Fashion', 'Health & Fitness', 'Science & Tech', 'Community Clipboard'].map((dept, i) => (
          ...
          >
            <h3 style={{ color: '#2563eb', marginBottom: 8 }}>{dept}</h3>
            <p style={{ color: '#4b5563', fontSize: 14 }}>Explore tools or submit content for {dept}</p>
            <button style={{ marginTop: 10, padding: '10px 20px', background: '#2563eb', color: '#ffffff', borderRadius: 8, fontWeight: 'bold', border: 'none' }}>Open</button>
          </div>
        ))}
      </div>
    </div>

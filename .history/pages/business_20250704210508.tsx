...
export default function Business() {
  ...
  // Type-safe change handler (no 'checked' error)
  const handleFormChange = (
    e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>
  ) => {
    // Don't destructure e.target up front! (TS type guard works below)
    if (
  ...
  // Handles onboarding and payment, ensures coin is present

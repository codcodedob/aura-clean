...
import AuthPanel from "@/components/AuthPanel"; // or AuthForm
...
export default function Business(): React.JSX.Element {
  ...
  return (
    <div style={{ minHeight: "140vh", background: "#111", color: "#eee", padding: "36px 0", textAlign: "center" }}>
      <LogoRotator images={["/screenshots/Logo1.png", "/screenshots/Logo2.png", "/screenshots/Logo3.png", "/screenshots/Logo4.png", "/screenshots/Logo5.png"]} size={88} interval={900} />
      <h1 style={{ fontSize: 36, fontWeight: 700, margin: "28px 0 12px" }}>Business Solutions</h1>
      <p style={{ fontSize: 18, marginBottom: 38, maxWidth: 680, marginInline: "auto" }}>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 28, maxWidth: 1200, marginInline: "auto" }}>
        {businessOptions.map((option) => (
          <div key={option.key} style={{ background: "#222", border: "2px solid #444", borderRadius: 18, padding: "36px 32px 32px", minWidth: 300, flex: "1 0 310px", maxWidth: 370 }}>
      ...
      {modalInfo && (
        // [MODAL FORM FROM ORIGINAL COMPONENT - unchanged]

...
export default function Home() {
  ...
  {[' Art', ' Entertainment', ' Cuisine', ' Fashion', ' Health & Fitness', 'Science & Tech', ' Community Clipboard'].map((dept, i) => (
    <div key={i} style={{ background: 'linear-gradient(135deg, #1a1a1a, #222)', marginBottom: 16, padding: 16, borderRadius: 12, border: '1px solid #0f0', boxShadow: '0 0 12px rgba(rgba(0,0,0,0.7)' }}>

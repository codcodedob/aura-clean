    ...
    <div style={{ display: 'flex', height: '100vh' }}>
      ...
      <div style={{ flex: 1.1, padding: 20 }}>
        <Suspense fallback={<div>Loading Avatar...</div>}>
          {mode === 'focused' ? <FocusedAvatar key={avatarKey} /> : gridMode ? (
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gridTemplateRows: 'repeat(2, 1fr)', gap: 10 }}>
              <FullBodyAvatar key={avatarKey + '-tl'} position={[0, 0, 0]} />
              <FullBodyAvatar key={avatarKey + '-tr'} position={[1, 0, 0]} />
              <FullBodyAvatar key={avatarKey + '-br'} position={[2, 0, 0]} />
              <FullBodyAvatar key={avatarKey + '-bl'} position={[0, 1, 0]} />
              <FullBodyAvatar key={avatarKey + '-center'} position={[1, 1, 0]} />
            </div>

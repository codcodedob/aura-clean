...
const businessOptions: BusinessOption[] = [
  {
    ...
    formFields: [
      ...
      { name: "scopes", label: "Scopes (comma separated)", type: "text", required: true },
      { name: "dividends_eligible", label: "Eligible for Dividends", type: "checkbox" },
    ],
  },
  {
    key: "simple-site",
...
export default function Business() {
  ...
  const handleSubmitModal = async (e: React.FormEvent) => {
    ...
    try {
      if (modalInfo?.key === "artist-coin") {
        // Align property names to CoinInsert type
        const coinInsert: CoinInsert = {
          coinName: formState.coinName,
          symbol: formState.symbol,
          scopes: formState.scopes
            ? formState.scopes.split(",").map((s: string) => s.trim())
            : [],
          dividends_eligible: !!formState.dividends_eligible,
          active: true,
        };
  ...
  return (
    ...
    >
      ...
      >
        Pick the option that fits your vision. Fast onboarding, flexible
        ownership, real payments. Secure and easy.
      </p>
            ...
            style={{
              ...
              boxShadow:
                option.key === "simple-site"
                  ? "0 0 0 2.5px #2563eb99, 0 4px 30px #0af3"
                  : "0 1.5px 18px #d2e0f8a0",
              borderRadius: 18,

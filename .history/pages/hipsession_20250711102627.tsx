...
export default function HipSession() {
  ...
  // The category to preview — defaults to first filtered category
  ...
  useEffect(() => {
    async function fetchCategories() {
      ...
      if (error) {
        ...
        setPreviewCategory(data[0] ?? null); // set initial preview
      }
    }
    fetchCategories();
  }, [page, sortOrder]);
        ...
        <ul style={{ listStyle: 'none', padding: 0 }}>
          {filteredCategories.map((cat) => (
            <li
              ...
              onMouseLeave={() => setPreviewCategory(filteredCategories[0] ?? null)}
              style={{

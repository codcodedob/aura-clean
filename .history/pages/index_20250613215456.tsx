...
export default function Home() {
  ...
  return (
     style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', backgroundColor: '#000', color: '#fff' }}
    }}>
       style={{ position: 'absolute', top: 8, right: 12, fontSize: 12, color: '#888' }}>
        Featured • Sponsored
      </div>
    ...
    {({ height, width }) => (
     ...
     /</div> </div>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', padding: 20, borderLeft: '1px solid #333', borderRight: '1px solid #333', overflowY: 'auto', maxHeight: '100vh' }}>
        ...
        <h1>AURA</h1>
        <img
          src="/15588913-d19d-45c3-ba7a-78c8c4cbe88f.png"
          id="helmet-hud"
          alt="Aura Helmet HUD"
          onClick={() => {
...
{/* Footer */}
      <footer style={{ padding: '1rem 2rem', borderTop: '1px solid #222', background: 'rgba(255,255,255,0.05)', backdropFilter: 'blur(4px)', textAlign: 'center', color: '#666' }}>
        <p style={{ fontSize: 12 }}>© 2025 AURA • All rights reserved</p>
      </footer>
    </div>
    </>
}

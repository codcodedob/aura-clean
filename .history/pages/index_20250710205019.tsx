...
import { createUserStripeCustomer } from "@/lib/create-user";
...
export default function Home() {
  ...
  const [darkMode, setDarkMode] = useState(true); // default true for black scheme
    ...
    <div style={{
        ...
        <div style={{
          ...
          {!user ? (
                ...
                onSubmit={async (e) => {
                  ...
                  if (signupMode) {
                    ...
                    if (error) setSignupError(error.message);
                      ...
                      try {
                        await createUserStripeCustomer(data.user.id, email);
                      } catch (err) {
                        console.error("Stripe customer creation failed:", err);
                        setSignupError("Account created but Stripe setup failed. Please contact support.");
                      }
            ...
            <div style={{
              ...
              <p style={{ margin: "8px 0 16px 0", color: "#ccc" }}>
      ...
      {(windowWidth >= 800 || activePanel === "right") && (
        <div style={{
          ...
          <h3 style={{ marginBottom: 12, fontWeight: "bold", fontSize: 18 }}>Business Suite</h3>
          <BusinessCarousel />
          <div style={{ marginTop: 20, color: "#666", fontSize: 14 }}>
            <p><Info size={16} /> Welcome to the business suite! Here you can manage investments, view your profile, and explore featured coins.</p>

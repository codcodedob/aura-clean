    ...
    <div style={{
      ...
      {(windowWidth >= 800 || activePanel === "center") && (
        <div style={{
          ...
          <button onClick={toggleMode} style={{ marginTop: 12, color: "#0af", border: "none", background: "transparent", fontWeight: 700 }}>Toggle Fit</button>
          {mode === "full-body" && (
            <button onClick={() => setGridMode(!gridMode)} style={{ marginLeft: 10, color: "#0af", border: "none", background: "transparent", fontWeight: 700 }}>Layout/Grid View</button>
          )}

...
const ADMIN_EMAIL = "admin@email.com"; // <-- Update as needed
...
// Utility: fetches user coin or creates default (matching your aura_coins schema)
async function getOrCreateUserCoin(user: any) {
...
export default function Business() {
  ...
  // Checkbox-safe form change handler
  ...
  const handleSubmitModal = async (e: React.FormEvent) => {
    ...
    try {
      if (modalInfo?.key === "artist-coin") {
        // Artist Coin is free, create coin and contracts using table schema

...
export default function ArtBusinessPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", color: "#fff", position: "relative", overflow: "hidden" }}>
      ...
      {/* Top Onboarding and Directions (30%) */}
      ...
      {/* Map and Content Grid (60%) */}
      <div style={{ display: "flex", height: "60vh", width: "100vw", position: "relative", zIndex: 1 }}>
        {/* Map Section */}
        {mapVisible && (
          <div style={{ flex: 1 }}>
            <GoogleMapReact
        ...
        <div style={{
          ...
          {/* Bottom Row - Wallet */}
          <div style={{ gridColumn: "1 / span 3", pointerEvents: "auto" }}>

  ...
  return (
    <div style={{ minHeight: "100vh", color: "#fff", position: "relative", background: "#000" }}>
      ...
      {departments.map(dept => (
        <div key={dept} style={{ padding: 24 }}>
          <h2 style={{ color: "#39ff14", textAlign: "center" }}>
            {dept.replace(/_/g, " ").replace(/\b\w/g, c => c.toUpperCase())} Department
          </h2>
          <BusinessCarousel department={dept} />
        </div>
      ))}
      ...
      <div style={{ padding: 24 }}>
        <div style={{ background: "#181f1b", borderRadius: 12, padding: 16 }}>
          <div style={{ fontSize: 18, fontWeight: 700, color: "#39ff14", marginBottom: 6 }}>IdeaFlight</Absolutely, here’s how to patch the error and get the carousel (and the homepage) rendering **correctly** using your `BusinessCarousel`:

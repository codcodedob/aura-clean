  ...
  return (
    <div style={{ minHeight: "100vh", color: "#fff", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ 
        ...
        <div style={{ display: "flex", gap: 8, overflowX: "auto" }}>
          {["halo id", "birthday", "age", "sex", "address", "a == i parents halo id", "z == other parent halo id", "username", "display image or 3D model", "archalogen status", "user id", "shipping address", "create halo range"].map((step, i) => (
            <div key={step} style={{
              background: "#444",
              color: "#fff",
              padding: "6px 12px",

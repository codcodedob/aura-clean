            ...
            {currentField === 'portfolio' ? (
                ...
                {portfolioOptions.map(opt => (
                  <label
                    ...
                    style={{
                      ...
                      background: userData.portfolio?.includes(opt) ? '#39ff14' : '#444',
                      color: '#000'
                    }}
                  >
                    <input
                      type="checkbox"
                      checked={userData.portfolio?.includes(opt)}
                      onChange={() => {
              ...
              <input
                ...
                style={{
                  ...
                  borderRadius: 4, border: '1px solid #444', background: '#222', color: '#fff'
                }}
              />
            )}
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: 8 }}>
              <button onClick={() => setEditingFieldIndex(null)} style={{ background: 'transparent', color: '#ccc' }}>
                Cancel
              </button>
              <button onClick={handleSaveField} style={{ background: '#39ff14', color: '#000', padding: '6px 12px', borderRadius: 4 }}>
                Save
              </button>
            </div>
          </motion.div>

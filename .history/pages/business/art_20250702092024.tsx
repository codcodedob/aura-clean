// Updated art.tsx with horizontal onboarding and Artgang button moved to end of business flow
...
export default function ArtDepartment() {
  ...
  return (
    <div style={{ padding: 0, background: '#000000', minHeight: '100vh', color: '#fff', position: 'relative' }}>
      ...
      <MotionSection>
        <div style={{ display: 'flex', justifyContent: 'center', overflowX: 'auto', padding: '24px 12px', gap: 20 }}>

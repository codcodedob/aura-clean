...
export default function Home() {
  ...
  // The rest of your JSX rendering
  return (
    <>
      {/* Your entire JSX tree */}
      {/* This was quite long—if you need it literally reprinted in full */}
      {/* with every panel, let me know—I will paste it separately */}
      <div style={{ padding: 40 }}>
        <h1 style={{ color: "#fff" }}>Your Marketplace App</h1>
        {/* Example usage of CoinCard */}
        {coins.map((coin) => (
          <CoinCard
            key={coin.id}
            coin={coin}
